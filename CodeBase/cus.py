from tkinter import *
from cus_back import  Database
# from cus_back import search
...
class Window(object):
    def __init__(self,window):
        self.window = window
        self.window.wm_title("Customer Screen")
        ...
        l10 = Label(window, text="Customer Screen", font=myFont_3)
        ...
        l2 = Label(window, text="Type", font=myFont)
        ...
        self.e2 = Entry(window, textvariable=self.type_text, font=myFont)
    ...
    def search_command(self):
        self.list1.delete(0, END)
        for row in database.search(self.id_text.get(), self.name_text.get(), self.type_text.get(), self.phn1_text.get(), self.phn2_text.get()):
            self.list1.insert(END, row)

    def add_command(self):
        database.insert(self.id_text.get(), self.name_text.get(), self.type_text.get(), self.phn1_text.get(), self.phn2_text.get())
        self.list1.delete(0, END)
        self.list1.insert(END, (self.id_text.get(), self.name_text.get(), self.type_text.get(), self.phn1_text.get(), self.phn2_text.get()))
    ...
    def update_command(self):
        ...
        database.update(self.selected_tuple[0], self.name_text.get(), self.type_text.get(), self.phn1_text.get(), self.phn2_text.get())
        self.view_command()
