from tkinter import *
from procat_back import  Database
...
class Window(object):
    def __init__(self,window):
        self.window = window
        self.window.wm_title("Product Category Screen")
        ...
        l10 = Label(window, text="Product Category Screen", font=myFont_3)
        ...
        l1 = Label(window, text="Description", font=myFont)
        ...
        self.e1 = Entry(window, textvariable=self.des_text, font=myFont)
    ...
    def search_command(self):
        self.list1.delete(0, END)
        for row in database.search(self.id_text.get(), self.des_text.get()):
            self.list1.insert(END, row)

    def add_command(self):
        database.insert(self.id_text.get(), self.des_text.get())
        self.list1.delete(0, END)
        self.list1.insert(END, (self.id_text.get(), self.des_text.get()))
    ...
    def update_command(self):
        ...
        database.update(self.selected_tuple[0], self.des_text.get())
        self.view_command()
