...
class Window(object):
    def __init__(self,window):
        self.window = window
        self.window.wm_title("Employee Screen")
        ...
        l10 = Label(window, text="Employee Screen", font=myFont_3)
        ...
        # self.e1 = OptionMenu(window, variable, *OPTIONS)
        ...
        # self.e1 = OptionMenu(window, self.name_text, *OPTIONS)
        # self.e1.grid(row=1, column=1)
        ...
        self.e2 = Entry(window, textvariable=self.level_text, font=myFont)
        self.e2.grid(row=2, column=1, pady=20)

        self.phn1_text = StringVar()
        self.e3 = Entry(window, textvariable=self.phn1_text, font=myFont)
        self.e3.grid(row=0, column=3, pady=20)

        self.phn2_text = StringVar()
        self.e4= Entry(window, textvariable=self.phn2_text, font=myFont)
    ...
    def search_command(self):
        self.list1.delete(0, END)
        for row in database.search(self.id_text.get(), self.name_text.get(), self.level_text.get(), self.phn1_text.get(), self.phn2_text.get()):
            self.list1.insert(END, row)

    def add_command(self):
        database.insert(self.id_text.get(), self.name_text.get(), self.level_text.get(), self.phn1_text.get(), self.phn2_text.get())
        self.list1.delete(0, END)
        self.list1.insert(END, (self.id_text.get(), self.name_text.get(), self.level_text.get(), self.phn1_text.get(), self.phn2_text.get()))
    ...
    def update_command(self):
        ...
        database.update(self.selected_tuple[0], self.name_text.get(), self.level_text.get(), self.phn1_text.get(), self.phn2_text.get())
        self.view_command()
